...
export default class DraggableView extends Component {
    ...
    startAnimation = (velocityY, positionY, initialPositon, id, finalPosition) => {
        ...
        // var endPosition = isGoingToUp ? finalPosition/2 : initialPositon/2 + 50;
        var endPosition = initialPositon + 50;
        if (isGoingToUp) {
            endPosition = positionY < initialPositon / 2 + 50 || Math.abs(velocityY) > 1 ? finalPosition + 50 : initialPositon / 2 + 50;
        } else {
            endPosition = positionY > initialPositon / 2 + 50 || Math.abs(velocityY) > 1 ? initialPositon + 50 : initialPositon / 2 + 50;
        }
